...
public class DolnyPanel {
	...
	public String nacitajSpravy() {
		...
		try (BufferedReader br = new BufferedReader(
				new InputStreamReader(new FileInputStream(Nastavenia.DOLNY_PANEL_SUBOR), StandardCharsets.UTF_8))) {
	...
	public void aktualizujVelkost() {
		fontTracking
				.set(Font.font((Main.root.getWidth() / Main.root.getHeight()) * Nastavenia.DOLNY_PANEL_FONT_VELKOST));
		spustiAnimaciu();
	}
